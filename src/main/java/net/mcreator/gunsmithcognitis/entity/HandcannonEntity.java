...
public class HandcannonEntity extends AbstractArrow implements ItemSupplier {
	public HandcannonEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(GunsmithCognitisModEntities.HANDCANNON.get(), world);
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		FlintlockHandMortarProjectileHitsBlockProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity());
	}
	...
	public static HandcannonEntity shoot(Level world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		HandcannonEntity entityarrow = new HandcannonEntity(GunsmithCognitisModEntities.HANDCANNON.get(), entity, world);
	...
	public static HandcannonEntity shoot(LivingEntity entity, LivingEntity target) {
		HandcannonEntity entityarrow = new HandcannonEntity(GunsmithCognitisModEntities.HANDCANNON.get(), entity, entity.level);
