...
public class HandcannonItem extends Item {
	public HandcannonItem() {
		super(new Item.Properties().tab(GunsmithCognitisModTabs.TAB_GUNSMITH_COGNITIS_TAB).durability(45));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("Matchlock Tier: Requires gunpowder and mortar balls to load"));
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (HandcannonCanUseRangedProcedure.execute(world, x, y, z, entity)) {
				HandcannonEntity entityarrow = HandcannonEntity.shoot(world, entity, world.getRandom(), 2.5f, 4, 1);
