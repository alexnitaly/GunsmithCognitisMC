...
public class DoubleBarrelShotgunItem extends Item {
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (DoubleBarrelShotgunCanBeUsedProcedure.execute(world, x, y, z, entity)) {
				DoubleBarrelShotgunEntity entityarrow = DoubleBarrelShotgunEntity.shoot(world, entity, world.getRandom(), 4f, 1.5, 1);
