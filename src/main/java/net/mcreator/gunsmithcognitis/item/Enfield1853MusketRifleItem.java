...
public class Enfield1853MusketRifleItem extends Item {
	public Enfield1853MusketRifleItem() {
		super(new Item.Properties().tab(GunsmithCognitisModTabs.TAB_GUNSMITH_COGNITIS_PERCUSSIONCAP_TAB).durability(877));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (Enfield1853MusketRifleCanUseRangedProcedure.execute(world, x, y, z, entity)) {
				Enfield1853MusketRifleEntity entityarrow = Enfield1853MusketRifleEntity.shoot(world, entity, world.getRandom(), 5f, 2, 0);
