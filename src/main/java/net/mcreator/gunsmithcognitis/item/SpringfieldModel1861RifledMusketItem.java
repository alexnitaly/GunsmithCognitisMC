...
public class SpringfieldModel1861RifledMusketItem extends Item {
	public SpringfieldModel1861RifledMusketItem() {
		super(new Item.Properties().tab(GunsmithCognitisModTabs.TAB_GUNSMITH_COGNITIS_PERCUSSIONCAP_TAB).durability(901));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (SpringfieldModel1861CanUseRangedProcedure.execute(world, x, y, z, entity)) {
				SpringfieldModel1861RifledMusketEntity entityarrow = SpringfieldModel1861RifledMusketEntity.shoot(world, entity, world.getRandom(), 5.5f, 2, 0);
