...
public class GunsmithCognitisModMenus {
	...
	public static final MenuType<ResearchTableUIMenu> RESEARCH_TABLE_UI = register("research_table_ui", (id, inv, extraData) -> new ResearchTableUIMenu(id, inv, extraData));
