...
public class SawnOffDoubleBarrelShotgunOffhandReloadProcedure {
	public static void execute(Entity entity) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getOrCreateTag().getDouble("ammo") < 2
			...
			if (entity instanceof Player _playerHasItem ? _playerHasItem.getInventory().contains(new ItemStack(GunsmithCognitisModItems.SHOTGUN_SHELL.get())) : false) {
				...
				(entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getOrCreateTag().putDouble("cooldown", 45);
			}
		}
	}
}
